...
function Registration() {
  return (
    <>
      ...
      <p><a className={styles.link} rel="noreferrer" target="_blank" href="https://www.danhotels.com/HaifaHotels/DanCarmelHaifaHotel"> Dan Carmen Hotel</a> – 217$ per night<br />
         <a className={styles.link} rel="noreferrer" target="_blank" href="https://www.danhotels.com/HaifaHotels/DanCarmelHaifaHotel"> Dan Panorama Haifa Hotel</a> – 150$ per night<br />
         <a className={styles.link} rel="noreferrer" target="_blank" href="https://www.danhotels.com/HaifaHotels/MirabellePlazaHaifaHotel"> Mirabelle Plaza Haifa</a> – 160$ per night<br />
         <a className={styles.link} rel="noreferrer" target="_blank" href="https://www.leonardo-hotels.com/haifa/leonardo-plaza-haifa"> Leonardo Plaza Haifa</a> – 195$ per night<br />
         <a className={styles.link} rel="noreferrer" target="_blank" href="http://carmella-boutique-hotel.haifa-hotels-il.com/en/"> Carmella Boutique Hotel</a> – 145$ per night<br />
         <a className={styles.link} rel="noreferrer" target="_blank" href="https://www.goldencrown-hotels.com/templars-boutique-hotel-haifa"> Templars Boutique Hotel</a> - 250$ per night<br />
